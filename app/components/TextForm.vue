...
const emit = defineEmits<{
  (e: 'update:modelValue', value: TextConfig): void
  (e: 'valid', value: boolean): void
}>()

const local = ref<TextConfig>({ ...props.modelValue })
...
const isValid = computed(() => local.value.text.trim().length > 0)
  ...
  <div class="bg-white rounded-xl shadow-lg overflow-hidden">
    ...
    <div class="p-6 space-y-4">
      <div>
        ...
        <textarea v-model="local.text" rows="4" placeholder="Enter any text…"
